...
model; redeclare var x{i in 1..6, k in 0..N} binary;
model; redeclare var a{k in 0.. N-1} binary;redeclare var f{k in 0.. N-1} binary;redeclare var p{k in 0.. N-1} binary;
